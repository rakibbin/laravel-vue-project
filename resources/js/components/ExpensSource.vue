...
export default {
    ...
    methods: {
        getUser() {
            axios
                .get("http://127.0.0.1:8000/api/rakib/expense/")
                .then((result) => {
        ...
        save() {
            axios
                .post("http://127.0.0.1:8000/api/rakib/expense/", {
                    name: this.name,
                    status: this.status,
        ...
        deleteUser(id) {
            axios
                .delete("http://127.0.0.1:8000/api/rakib/expense/" + id)
                .then(() => {
                    this.getUser();
                });
        },
        updateUser() {
            axios
                .put("http://127.0.0.1:8000/api/rakib/expense/" + this.id, {
                    name: this.name,
                    status: this.status,
                })
                .then((response) => {
        ...
        showUser(id) {
            this.id = id;
            axios
                .get("http://127.0.0.1:8000/api/rakib/expense/" + id + "/edit")
                .then((response) => {
