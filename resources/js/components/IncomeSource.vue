...
export default {
    ...
    methods: {
        getUser() {
            axios
                .get("http://127.0.0.1:8000/api/rakib/incomes/")
                .then((result) => {
        ...
        save() {
            axios
                .post("http://127.0.0.1:8000/api/rakib/incomes/", {
                    name: this.name,
                    status: this.status,
        ...
        deleteUser(id) {
            axios
                .delete("http://127.0.0.1:8000/api/rakib/incomes/" + id)
                .then(() => {
                    this.getUser();
                });
        },
        updateUser() {
            axios
                .put("http://127.0.0.1:8000/api/rakib/incomes/" + this.id, {
                    name: this.name,
                    status: this.status,
                })
                .then((response) => {
        ...
        showUser(id) {
            this.id = id;
            axios
                .get("http://127.0.0.1:8000/api/rakib/incomes/" + id + "/edit")
                .then((response) => {
